def main():
    Hero_file = open('List_Hero.txt','rw')
    Make_loop = 'y'
    
    Listname = ['Ironman','Thor','Hulk','Superman','Spiderman','Dr.Strange','Cpt. America',\
        'Black Panther', 'Ant Man']
    def Show_hero(Listname):
        Display_Hero = Hero_file.read()
        Hero_file.close()
        return print(Display_Hero)
    def addhero(name):
        Add_Hero = Hero_file.write(name)
